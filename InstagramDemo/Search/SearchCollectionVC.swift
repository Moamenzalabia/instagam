...
class SearchCollectionVC: UICollectionViewController, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    lazy var searchBar: UISearchBar = {
        ...
        search.barTintColor = UIColor.gray
    ...
    fileprivate func fetchUsers () {
        ...
        ref.observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            guard let valueDictionaries = snapshot.value as? [String: Any] else { return }
            valueDictionaries.forEach({ (key, value) in
            ...
            print("Failed to fetch users for search", error.localizedDescription)
        }
